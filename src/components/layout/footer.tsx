    ...
    <footer className="mt-188px w-full border-t border-gray-200 shadow-[0_-1px_4px_rgba(0,0,0,0.05)]">
      <div className="max-w-7xl mx-auto px-4 py-5">
        <div className="flex justify-between items-start">
          {/* Left side */}
          <div>
            <div className="bg-white text-black text-xs mb-4 pt-1 pb-1 pl-3 pr-3 bg-slate-100 max-w-[200px]">
            ...
            <div className="flex items-center gap-4">
              <Link
                ...
                className="bg-white text-black px-4 py-2 rounded-md hover:bg-gray-800 transition-colors text-xs"
              >
          ...
          <div className="flex flex-col items-end gap-4">
            <div className="flex items-center gap-2 pt-8">
              <span className="text-gray-300 font-sans">MADE WITH</span>
              <span className="text-red-500 text-xl font-sans">♥</span>
              <span className="text-gray-300 font-sans">BY</span>
            ...
            {/* Social links */}
            <div className="flex items-center">
              <span className="mr-4 text-gray-300 pt-4 font-sans">Follow us on</span>
