...
import { FireMage } from '@/components/characters/fire-mage'
...
// Original StatBar for character card
...
// Keep existing CharacterCard implementation exactly as is
          ...
          >
            ...
            <div className="px-16 py-16">
              <h2 className={cn(
                ...
                {isBack ? "Attributes & Abilities" : "Fire Mage"}
              </h2>

              {!isBack ? (
                // Front content - Keep exactly as before
                  ...
                  <div className="space-y-2">
                    <div>
                      <h3 className={cn(
                        ...
                        Master of the Arcane Flames
                      </h3>
                    </div>

                    <p className="italic text-gray-900 leading-relaxed pr-4">
                      "Born amidst the eternal flames of the Phoenix Mountains, 
                      the Fire Mage channels ancient powers that have been passed 
                      down through generations of mystical practitioners."
                    </p>
                  </div>
                </div>
              ) : (
                // Back content - Adjusted to use full width
                <div className="flex flex-col gap-6 pl-12">
                  <div className="space-y-2">
                    <StatBar label="Strength" value={5} maxValue={10} color="red" />
                    <StatBar label="Intelligence" value={8} maxValue={10} color="blue" />
                    <StatBar label="Health Points" value={6} maxValue={10} color="green" />
                    <StatBar label="Agility" value={4} maxValue={10} color="yellow" />
        ...
        <div className={cn(
          ...
          <div className="px-16 py-16">
            ...
            <div className="absolute right-4 top-[150px]">
              <div className="space-y-2">
                <OverviewStatBar label="Strength" value={5} maxValue={10} color="red" />
                <OverviewStatBar label="Intelligence" value={8} maxValue={10} color="blue" />
                <OverviewStatBar label="Health Points" value={6} maxValue={10} color="green" />
                <OverviewStatBar label="Agility" value={4} maxValue={10} color="yellow" />
