          ...
          <div className="px-16 py-16">
            ...
            <div className="absolute right-4 top-[150px]">
              <div className="space-y-2">
                <OverviewStatBar label="Strength" value={3} maxValue={10} color="red" />
                <OverviewStatBar label="Intelligence" value={10} maxValue={10} color="blue" />
                ...
                <OverviewStatBar label="Magic Points" value={10} maxValue={10} color="purple" />
              </div>
          ...
          >
            ...
            <div className="px-16 py-16">
              <h2 className={cn(
                ...
                {isBack ? "Attributes & Abilities" : "Wizard"}
              </h2>
              ...
              {!isBack ? (
                ...
                <div className="flex flex-col gap-6 ml-[200px]">
                  <div className="space-y-2">
                    ...
                    <p className="italic text-gray-900 leading-relaxed pr-4">
                      "Masters of ancient knowledge and wielders of powerful magic, 
                      Wizards shape reality itself with their arcane arts."
                    </p>
                  </div>
                </div>
              ) : (
                ...
                <div className="flex flex-col gap-6 pl-12">
                  <div className="space-y-2">
                    <StatBar label="Strength" value={3} maxValue={10} color="red" />
                    <StatBar label="Intelligence" value={10} maxValue={10} color="blue" />
                    <StatBar label="Health Points" value={5} maxValue={10} color="green" />
                    <StatBar label="Agility" value={4} maxValue={10} color="yellow" />
                    <StatBar label="Magic Points" value={10} maxValue={10} color="purple" />
                  </div>
