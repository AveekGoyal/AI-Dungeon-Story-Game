...
import { DarkMage } from '@/components/characters/dark-mage'
          ...
          <div className="px-16 py-16">
            ...
            <div className="absolute right-4 top-[150px]">
              <div className="space-y-2">
                ...
                <OverviewStatBar label="Intelligence" value={9} maxValue={10} color="blue" />
          ...
          >
            ...
            <div className="px-16 py-16">
              <h2 className={cn(
                ...
                {isBack ? "Attributes & Abilities" : "Dark Mage"}
              </h2>
              ...
              {!isBack ? (
                  ...
                  <div className="space-y-2">
                    <div>
                      <h3 className={cn(
                        ...
                        Wielder of Shadow Magic
                      </h3>
                    </div>

                    <p className="italic text-gray-900 leading-relaxed pr-4">
                      "From the depths of the Shadowrealm, the Dark Mage harnesses 
                      forbidden knowledge and ancient dark arts, commanding powers 
                      that few dare to comprehend."
                    </p>
                  </div>
                </div>
              ) : (
                ...
                <div className="flex flex-col gap-6 pl-12">
                  <div className="space-y-2">
                    ...
                    <StatBar label="Intelligence" value={9} maxValue={10} color="blue" />
                    <StatBar label="Health Points" value={5} maxValue={10} color="green" />
                    <StatBar label="Agility" value={6} maxValue={10} color="yellow" />
