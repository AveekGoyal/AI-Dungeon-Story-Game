...
import { Rapier } from '@/components/characters/rapier'
          ...
          >
            ...
            <div className="px-16 py-16">
              <h2 className={cn(
                ...
                {isBack ? "Attributes & Abilities" : "Rapier"}
              </h2>
              ...
              {!isBack ? (
                ...
                <div className="flex flex-col gap-6 ml-[200px]">
                  <div className="space-y-2">
                    ...
                    <p className="italic text-gray-900 leading-relaxed pr-4">
                      "With lightning-fast strikes and elegant footwork, the Rapier 
                      warrior dances through battle, their blade a blur of deadly precision."
                    </p>
                  </div>
                </div>
              ) : (
                ...
                <div className="flex flex-col gap-6 pl-12">
                  <div className="space-y-2">
                    ...
                    <StatBar label="Magic Points" value={3} maxValue={10} color="purple" />
                  </div>
